...
<div class="recent-bookings-table">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <?php
            $sql = "SELECT tblbooking.BookingId, tblbooking.UserEmail, tblbooking.FromDate, tblbooking.ToDate, tblbooking.status, tblbooking.RegDate, tbltourpackages.PackageName 
                    FROM tblbooking 
